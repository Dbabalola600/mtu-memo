...
export default function UnreadCollege() {
    ...
    const getInfo = async () => {
        ...
        const body2 = {
            id: token,
            name: response?.College
        }

        const response2 = await fetch("/api/user/Memo/College/GetUnreadCollege", { method: "POST", body: JSON.stringify(body2) })
